...
qryOrdenLaboratorioEnc_SelDetalle_PorUsuario @strUsuario = 'JORGE', @intEsVersion2024 = 1 ,@intDoctor = 81, @intProtesis = 0, @intProceso = 7
go


select * from tbordenlaboratorioenc where intordenlaboratorioenc =1002
